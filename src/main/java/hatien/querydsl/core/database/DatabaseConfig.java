...
/**
 * Configuration class for database connection settings. Holds JDBC connection
 * parameters and database-specific settings.
 */
public class DatabaseConfig {
	 ...
	 */
	public DatabaseConfig(String url, String username, String password, String driverClassName, int maxPoolSize,
	...
	public static DatabaseConfig h2InMemory(String databaseName) {
		return new DatabaseConfig("jdbc:h2:mem:" + databaseName + ";DB_CLOSE_DELAY=-1;DB_CLOSE_ON_EXIT=FALSE", "sa", "",
				"org.h2.Driver");
	}
	...
	public static DatabaseConfig h2File(String filePath) {
		return new DatabaseConfig("jdbc:h2:file:" + filePath, "sa", "", "org.h2.Driver");
	}
	...
	public static DatabaseConfig postgresql(String host, int port, String database, String username, String password) {
		return new DatabaseConfig("jdbc:postgresql://" + host + ":" + port + "/" + database, username, password,
