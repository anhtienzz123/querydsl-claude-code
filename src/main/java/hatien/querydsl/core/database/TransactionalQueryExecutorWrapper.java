...
/**
 * Wrapper that adapts TransactionalQueryExecutor to the QueryExecutor
 * interface. This allows transactional executors to be used wherever
...
public class TransactionalQueryExecutorWrapper extends QueryExecutor {
	...
	public ConnectionManager getConnectionManager() {
		return transactionalExecutor.getTransaction().getConnection() != null ? super.getConnectionManager() : null;
	}
}