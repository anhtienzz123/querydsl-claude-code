...
/**
 * Expression representing the AVG aggregate function in SQL.
 * AVG calculates the average of all numeric values in a column.
 * Always returns BigDecimal for precision in decimal calculations.
 *
