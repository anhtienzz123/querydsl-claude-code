...
public abstract class ComparableExpression<T extends Comparable<T>> extends SimpleExpression<T> {
	 ...
	 *
	 * @param type the Class object representing the comparable type of this
	 *             expression
	 */
	...
	/**
	 * Creates a less-than predicate comparing this expression to the specified
	 * value.
	 *
	...
	/**
	 * Creates a less-than-or-equal predicate comparing this expression to the
	 * specified value.
	 *
	 * @param value the value to compare against
	...
	/**
	 * Creates a greater-than predicate comparing this expression to the specified
	 * value.
	 *
	 * @param value the value to compare against
	...
	/**
	 * Creates a greater-than-or-equal predicate comparing this expression to the
	 * specified value.
	 *
	 * @param value the value to compare against
	...
	/**
	 * Creates a BETWEEN predicate testing if this expression's value falls within
	 * the specified range.
	 *
