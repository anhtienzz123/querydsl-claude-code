...
/**
 * Utility class providing static factory methods for creating common SQL
 * expressions including aggregate functions and CASE WHEN constructs. This
 * class provides a convenient API for building complex expressions.
 */
public final class ExpressionUtils {
	 ...
	 * 
	 * <pre>
	 * CaseExpression&lt;String&gt; caseExpr = ExpressionUtils.caseWhen(String.class).when(user.age.lt(18), "Minor")
	...
	/**
	 * Creates a simple CASE expression for String values. This is a convenience
	 * method for the most common case.
	 *
