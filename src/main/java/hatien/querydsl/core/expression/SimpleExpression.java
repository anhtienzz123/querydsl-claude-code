...
public abstract class SimpleExpression<T> implements Expression<T> {
    ...
    /**
     * Creates an equality predicate comparing this expression to the specified value.
     *
    ...
    /**
     * Creates a not-equal predicate comparing this expression to the specified value.
     *
     * @param value the value to compare against
    ...
    /**
     * Creates a predicate that tests if this expression's value is in the specified set of values.
     *
