...
public abstract class StringExpression extends ComparableExpression<String> {
	...
	/**
	 * Creates a predicate that tests if this string expression contains the
	 * specified substring.
	 *
	...
	/**
	 * Creates a predicate that tests if this string expression starts with the
	 * specified prefix.
	 *
	...
	/**
	 * Creates a predicate that tests if this string expression ends with the
	 * specified suffix.
	 *
	...
	/**
	 * Creates a predicate that tests if this string expression is empty (has zero
	 * length).
	 *
	...
	/**
	 * Creates a predicate that tests if this string expression is not empty (has
	 * non-zero length).
	 *
