...
/**
 * Abstract base class for entity metadata that provides path creation and
 * management for entity properties. This class serves as a foundation for
 * generated query types that need to create and manage path expressions for
 * entity properties.
 *
...
public abstract class EntityMetadata<T> {
	...
	/**
	 * Creates and registers an EntityPath for an entity-valued property of this
	 * entity. This is used for associations/relationships to other entities.
	 *
