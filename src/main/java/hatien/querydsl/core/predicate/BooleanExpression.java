...
public class BooleanExpression extends SimpleExpression<Boolean> implements Predicate {
	...
	public enum PredicateType {
		EQ, NE, LT, GT, LOE, GOE, BETWEEN, IS_NULL, IS_NOT_NULL, IN, LIKE, CONTAINS, STARTS_WITH, ENDS_WITH, IS_EMPTY,
		IS_NOT_EMPTY, AND, OR, NOT
	}

	/**
	 * Constructs a new BooleanExpression with the specified predicate type and
	 * operands.
	 *
