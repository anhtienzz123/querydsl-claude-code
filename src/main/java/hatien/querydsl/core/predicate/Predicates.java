...
/**
 * Utility class providing static factory methods for creating predicate
 * expressions. This class cannot be instantiated.
 */
public final class Predicates {
	...
	/**
	 * Creates a BETWEEN predicate testing if an expression's value falls within a
	 * range.
	 *
