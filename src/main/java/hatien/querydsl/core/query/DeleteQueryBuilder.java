...
/**
 * Implementation of the DeleteQuery interface that builds SQL DELETE statements
 * using a fluent API. This class maintains internal lists for the target entity
...
public class DeleteQueryBuilder<T> implements DeleteQuery<T> {
	 ...
	 * {@inheritDoc}
	 * 
	 * Constructs a DELETE SQL string with optional WHERE clause: DELETE FROM table
	 * WHERE condition
	 */
	@Override
	public String toSQL() {
