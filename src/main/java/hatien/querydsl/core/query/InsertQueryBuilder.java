...
/**
 * Implementation of the InsertQuery interface that builds SQL INSERT statements
 * using a fluent API. This class maintains internal lists for the target
 * entity, columns, and values.
 *
...
public class InsertQueryBuilder<T> implements InsertQuery<T> {
	 ...
	 * {@inheritDoc}
	 * 
	 * Constructs an INSERT SQL string. Supports two modes: 1. Column/Values mode:
	 * INSERT INTO table (col1, col2) VALUES (val1, val2) 2. Set mode: INSERT INTO
	 * table (col1, col2) VALUES (val1, val2) using set() calls
	 */
	@Override
	public String toSQL() {
