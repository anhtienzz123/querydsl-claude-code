...
/**
 * Implementation of the Query interface that builds SQL queries using a fluent API.
 * This class maintains internal lists for each SQL clause and provides methods to
