...
/**
 * Implementation of the UpdateQuery interface that builds SQL UPDATE statements
 * using a fluent API. This class maintains internal lists for the target
 * entity, set clauses, and where conditions.
 *
...
public class UpdateQueryBuilder<T> implements UpdateQuery<T> {
	 ...
	 * {@inheritDoc}
	 * 
	 * Constructs an UPDATE SQL string with SET and optional WHERE clauses: UPDATE
	 * table SET col1 = val1, col2 = val2 WHERE condition
	 */
	@Override
	public String toSQL() {
