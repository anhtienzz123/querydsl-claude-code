 ...
 * prepared statements. This class collects all literal values that should be
...
public class ParameterExtractor implements ExpressionVisitor<List<Object>> {
	 ...
	 * {@inheritDoc}
	 * 
	 * Extracts parameter values from boolean expressions based on the predicate
	 * type. Returns all literal values that should be parameterized in prepared
	 * statements.
	 */
	@Override
	public List<Object> visit(BooleanExpression expression) {
		...
		case EQ, NE, LT, GT, LOE, GOE, LIKE -> {
			// Binary operations: left operand is usually a path, right operand is the
			// parameter
	 ...
	 * {@inheritDoc}
	 * 
	 * Extracts parameters from aggregate expressions. Aggregate functions may
	 * contain sub-expressions that have parameters.
	 */
	@Override
	 ...
	 * {@inheritDoc}
	 * 
	 * Extracts parameters from CASE expressions. This includes parameters from WHEN
	 * conditions, THEN values, and ELSE values.
	 */
	@Override
